...
Elm.App.make = function (_elm) {
   ...
   $SithList = Elm.SithList.make(_elm),
   $StartApp$Simple = Elm.StartApp.Simple.make(_elm);
   var main = $StartApp$Simple.start({_: {}
                                     ,model: $SithList.init
                                     ,update: $SithList.update
                                     ,view: $SithList.view});
...
Elm.Sith = Elm.Sith || {};
Elm.Sith.make = function (_elm) {
   "use strict";
   _elm.Sith = _elm.Sith || {};
   if (_elm.Sith.values)
   return _elm.Sith.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
...
Elm.SithList = Elm.SithList || {};
Elm.SithList.make = function (_elm) {
   "use strict";
   _elm.SithList = _elm.SithList || {};
   if (_elm.SithList.values)
   return _elm.SithList.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Sith = Elm.Sith.make(_elm);
   var viewSith = function (model) {
      return $Sith.view(model);
   };
   var view = F2(function (address,
   model) {
      return function () {
         var siths = A2($List.map,
         viewSith,
         model.siths);
         return A2($Html.ul,
